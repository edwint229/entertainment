...
import { FullscreenPlayerComponent } from './pages/fullscreen-player/fullscreen-player.component'

const routes: Routes = [
  { path: '', pathMatch: 'full', redirectTo: '/welcome' },
  { path: 'player', component: FullscreenPlayerComponent, pathMatch: 'full' },
  {
    path: 'welcome',
